  ...
  return (
    <div id="wrapper" className="block align-baseline max-w-[calc(100%-2em)] mx-auto sm:w-[90em]">
      ...
      <section id="footer" className="flex flex-col pt-10 px-4 pb-48 text-white sm:flex-row">
        ...
        <section className="">
          <p className="text-xl px-4 font-bold">Contact Information</p>
          <div className="text-white">
            <dl className="">
              <div class="px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt class="text-sm font-bold">Full name</dt>
                <dd class="mt-1 text-sm  sm:mt-0 sm:col-span-2">Gustavo Diaz Banuelos</dd>
              </div>
              <div class=" px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt class="text-sm font-bold">Address</dt>
                <dd class="mt-1 text-sm  sm:mt-0 sm:col-span-2">Chicago, IL • USA</dd>
              </div>
              <div class=" px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt class="text-sm font-bold">Phone</dt>
                <dd class="mt-1 text-sm  sm:mt-0 sm:col-span-2">(214) 734-2809</dd>
              </div>
              <div class=" px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt class="text-sm font-bold">Email</dt>
                <dd class="mt-1 text-sm  sm:mt-0 sm:col-span-2">
                  <a href="mailto:gdiazbanuelos@gmail.com" className="underline">gdiazbanuelos@gmail.com</a>
                </dd>
              </div>
              <div class=" px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt class="text-sm font-bold">Linkedin</dt>
                <dd class="mt-1 text-sm  sm:mt-0 sm:col-span-2">
                  <a href="https://www.linkedin.com/in/gdiazbanuelos/" className="underline">linkedin.com/in/gdiazbanuelos</a>
                </dd>
              </div>
              <div class=" px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt class="text-sm font-bold">GitHub</dt>
                <dd class="mt-1 text-sm  sm:mt-0 sm:col-span-2">
                  <a href="https://github.com/gdiazbanuelos" className="underline">github.com/gdiazbanuelos</a>
                </dd>
              </div>
            </dl>
          </div>
